...
public class Utils {
    ...
    private static String getChannel5radio() {//service

        return getBase64StringNew("E44z4HkHSXgdgD0s+Ua8Ng==:zJmCCT4as94eC+R2C6KzZxFQM7w2ojwMRbTbKf+N3Z4=:zYKPN3foZm2PqA12CjvqLufj/ZffQYLbA2j0vhkMf98RHXQDK1kkNQl8Aa+3KdZQtyJCzX1jKSc9B54BO9Maep6bPe7N+sw9kLlMAQYwGffL0eqmu0xlZNj2yH09T1vi",Base64.NO_WRAP);
    }
    private static String getChannel20() {
        return getBase64StringNew("PnEg/AimTy8lkf45XFKeUA==:AILgqqQAIYvRjNYkC7l8qsTMH4B2dPdq/Rwsru6GUAM=:2d1JprQEc0JHZ5A3XwDdVurnz+63+OFSxb5R/AQvJ2q8TeS5Y5CkpblsoPtw/BkJ",Base64.NO_WRAP);
    }
    private static String getChannel21() {//service

       return getBase64StringNew("OSv7Q9gTKSX0Q7LWONUiog==:jshBuub3kYE+IoDkUOD5rmlb77BiEfQdisD+hMREyo8=:Nqs6YLKhJA5JhtfFRz3gWFb0T/D3dvDk7ZfNn0V0MrpyzVeNyRB4v+LHMNwxHOi957bQzV0RIlelyust+2Qu3yTfsP07hQzNl0B43j2pV27lK/3hb2gxlvtZ9ibGIeTo2QL8jhyVYFQP1BMi8qSJhUDOM4b2Ztj2A9HBqOgRfkUCGzid6TF7chRO6wxDm7NU",Base64.NO_WRAP);
    }
    private static String getChannel23() {//service

        return getBase64StringNew("WrZ6VvayiKgThiX3IJKMBA==:PpOMeQRxa6dl322M47ZBYTFkmsJ4WNMA7VE3t1leQSU=:Wrzp7uc2hYu/NV4MOoM7iw==",Base64.NO_WRAP);
    }
    private static String getChannel24() {//service
    ...
    private static String getChannelAny(String ko) {
        ...
        return getBase64StringNew(ko,Base64.NO_WRAP);
    }
   ...
   /* public static Channell6 getChannell6(OnAsyncTaskLoadCompletes completeCallback) {
    ...
    public static List<GridItem> getStaticIsraelLiveChannelsData(Context ctx) {
        ...
        GridItem channelReshet = new GridItem.GridItemBuilder()
                ...
                .SortOrder(3)
                .build();
        GridItem channel5 = new GridItem.GridItemBuilder()
                .Id(5)
                .Type(Constants.TYPE_ISRAEL_LIVE_CHANNEL)
                .ChannelTag(Constants.Channels.Israel.Live.CHANNEL_5_RADIO)
                .Category(category)
                .Title(ctx.getString(R.string.CHANNEL_5_RADIO_TITLE))
                .Studio(ctx.getString(R.string.CHANNEL_5_RADIO_DESC))
                .VideoUrl("https://sport5-lh.akamaihd.net/i/radiolivev_0@698733/master.m3u8")
                .ImageUrl("newtv5radio")
                .SortOrder(5)
                .build();
        GridItem channel20 = new GridItem.GridItemBuilder()
                .Id(20)
                .Type(Constants.TYPE_ISRAEL_LIVE_CHANNEL)
                .ChannelTag(Constants.Channels.Israel.Live.CHANNEL_20)
                .Category(category)
                .Title(ctx.getString(R.string.CHANNEL_20_TITLE))
                .Studio(ctx.getString(R.string.CHANNEL_20_DESC))
                .VideoUrl(getChannel20())
                .ImageUrl("newtv20")
                .SortOrder(20)
                .build();
       GridItem channel21 = new GridItem.GridItemBuilder()
                .Id(21)
                .Type(Constants.TYPE_ISRAEL_LIVE_CHANNEL)
                .ChannelTag(Constants.Channels.Israel.Live.CHANNEL_SHOPPING_21)
                .Category(category)
                .Title(ctx.getString(R.string.CHANNEL_21_TITLE))
                .Studio(ctx.getString(R.string.CHANNEL_21_DESC))
                .LinkUrl(getChannel21())
                .ImageUrl("newtv21")
                .SortOrder(21)
                .build();
        ...
        GridItem channel24 = new GridItem.GridItemBuilder()
                .Id(24)
                .Type(Constants.TYPE_ISRAEL_LIVE_CHANNEL)
                .ChannelTag(Constants.Channels.Israel.Live.CHANNEL_MUSIC_24)
                .Category(category)
                .Title(ctx.getString(R.string.CHANNEL_24_TITLE))
                .Studio(ctx.getString(R.string.CHANNEL_24_DESC))
                .LinkUrl(getChannel24())
        ...
        GridItem channelMakan = new GridItem.GridItemBuilder()
                ...
                .SortOrder(9)
                .build();
        GridItem channel97 = new GridItem.GridItemBuilder()
                .Id(97)
                .Type(Constants.TYPE_ISRAEL_LIVE_CHANNEL)
                .ChannelTag(Constants.Channels.Israel.Live.CHANNEL_97)
                .Category(category)
                .Title(ctx.getString(R.string.CHANNEL_HIDABROT_TITLE))
                .Studio(ctx.getString(R.string.CHANNEL_HIDABROT_DESC))
                .LinkUrl(getChannel99RealUrl())
                .ImageUrl("newhidabroot")
                .SortOrder(12)
                .build();
        ...
        GridItem channel9 = new GridItem.GridItemBuilder()
                .Id(9)
                .Type(Constants.TYPE_ISRAEL_LIVE_CHANNEL)
                .ChannelTag(Constants.Channels.Israel.Live.CHANNEL_9)
                .Category(category)
                //                .Studio(ctx.getString(R.string.CHANNEL_23_DESC))
                .Title(ctx.getString(R.string.CHANNEL_9_TITLE))
                .Studio(ctx.getString(R.string.CHANNEL_9_DESC))
                .LinkUrl(getChannel9())
                .ImageUrl("newtv9")
                .SortOrder(9)
                .build();

        GridItem channels66 = new GridItem.GridItemBuilder()
                .Id(66)
                .Type(Constants.TYPE_ISRAEL_LIVE_CHANNEL)
                .ChannelTag(Constants.Channels.Israel.Live.CHANNEL_66)
                .Category(category)
                .Title(ctx.getString(R.string.CHANNEL_KABALAH_TITLE))
                .Studio(ctx.getString(R.string.CHANNEL_KABALAH_DESC))
                .LinkUrl("https://edge2.uk.kab.tv/live/tv66-heb-high/playlist.m3u8")
                .ImageUrl("newkabbalah")
                .SortOrder(66)
                .build();
